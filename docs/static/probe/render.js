...
window.ProbeRender = (function () {
  ...
  var TEST_URLS = {
    'COMP-405-ALLOW': '/docs/request-line/405-allow/',
    'COMP-ABSOLUTE-FORM': '/docs/request-line/absolute-form/',
    'COMP-ASTERISK-WITH-GET': '/docs/request-line/asterisk-with-get/',
    'COMP-BASELINE': '/docs/baseline/',
    'COMP-CHUNKED-BODY': '/docs/body/chunked-body/',
    'COMP-CHUNKED-EMPTY': '/docs/body/chunked-empty/',
    'COMP-CHUNKED-EXTENSION': '/docs/body/chunked-extension/',
    'COMP-CHUNKED-MULTI': '/docs/body/chunked-multi/',
    'COMP-CHUNKED-NO-FINAL': '/docs/body/chunked-no-final/',
    'COMP-DUPLICATE-HOST-SAME': '/docs/host-header/duplicate-host-same/',
    'COMP-DUPLICATE-CT': '/docs/headers/duplicate-ct/',
    'COMP-EXPECT-UNKNOWN': '/docs/headers/expect-unknown/',
    'COMP-GET-WITH-CL-BODY': '/docs/body/get-with-cl-body/',
    'COMP-HOST-WITH-PATH': '/docs/host-header/host-with-path/',
    'COMP-HOST-WITH-USERINFO': '/docs/host-header/host-with-userinfo/',
    'COMP-LEADING-CRLF': '/docs/line-endings/leading-crlf/',
    'COMP-LONG-URL-OK': '/docs/request-line/long-url-ok/',
    'COMP-METHOD-CASE': '/docs/request-line/method-case/',
    'COMP-METHOD-CONNECT': '/docs/request-line/method-connect/',
    'COMP-METHOD-TRACE': '/docs/request-line/method-trace/',
    'COMP-OPTIONS-ALLOW': '/docs/request-line/options-allow/',
    'COMP-OPTIONS-STAR': '/docs/request-line/options-star/',
    'COMP-POST-CL-BODY': '/docs/body/post-cl-body/',
    'COMP-POST-UNSUPPORTED-CT': '/docs/body/post-unsupported-ct/',
    'COMP-POST-CL-UNDERSEND': '/docs/body/post-cl-undersend/',
    'COMP-POST-CL-ZERO': '/docs/body/post-cl-zero/',
    'COMP-POST-NO-CL-NO-TE': '/docs/body/post-no-cl-no-te/',
    'COMP-SPACE-IN-TARGET': '/docs/request-line/space-in-target/',
    'COMP-TRACE-SENSITIVE': '/docs/request-line/trace-sensitive/',
    'COMP-UNKNOWN-METHOD': '/docs/request-line/unknown-method/',
    'COMP-UNKNOWN-TE-501': '/docs/request-line/unknown-te-501/',
    'COMP-RANGE-INVALID': '/docs/body/range-invalid/',
    'COMP-RANGE-POST': '/docs/body/range-post/',
    'WS-UPGRADE-HTTP10': '/docs/websockets/upgrade-http10/',
    'WS-UPGRADE-INVALID-VER': '/docs/websockets/upgrade-invalid-ver/',
    'WS-UPGRADE-MISSING-CONN': '/docs/websockets/upgrade-missing-conn/',
    'WS-UPGRADE-POST': '/docs/websockets/upgrade-post/',
    'WS-UPGRADE-UNKNOWN': '/docs/websockets/upgrade-unknown/',
    'COMP-VERSION-CASE': '/docs/request-line/version-case/',
    'COMP-ACCEPT-NONSENSE': '/docs/headers/accept-nonsense/',
    'COMP-WHITESPACE-BEFORE-HEADERS': '/docs/headers/whitespace-before-headers/',
    'MAL-BINARY-GARBAGE': '/docs/malformed-input/binary-garbage/',
    'MAL-CHUNK-EXT-64K': '/docs/malformed-input/chunk-extension-long/',
    'MAL-CHUNK-SIZE-OVERFLOW': '/docs/malformed-input/chunk-size-overflow/',
    'MAL-CL-EMPTY': '/docs/malformed-input/cl-empty/',
    'MAL-CL-OVERFLOW': '/docs/malformed-input/cl-overflow/',
    'MAL-CL-TAB-BEFORE-VALUE': '/docs/malformed-input/cl-tab-before-value/',
    'MAL-CONTROL-CHARS-HEADER': '/docs/malformed-input/control-chars-header/',
    'MAL-EMPTY-REQUEST': '/docs/malformed-input/empty-request/',
    'MAL-H2-PREFACE': '/docs/malformed-input/h2-preface/',
    'MAL-INCOMPLETE-REQUEST': '/docs/malformed-input/incomplete-request/',
    'MAL-LONG-HEADER-NAME': '/docs/malformed-input/long-header-name/',
    'MAL-LONG-HEADER-VALUE': '/docs/malformed-input/long-header-value/',
    'MAL-LONG-METHOD': '/docs/malformed-input/long-method/',
    'MAL-LONG-URL': '/docs/malformed-input/long-url/',
    'MAL-MANY-HEADERS': '/docs/malformed-input/many-headers/',
    'MAL-NON-ASCII-HEADER-NAME': '/docs/malformed-input/non-ascii-header-name/',
    'MAL-NON-ASCII-URL': '/docs/malformed-input/non-ascii-url/',
    'MAL-NUL-IN-HEADER-VALUE': '/docs/malformed-input/nul-in-header-value/',
    'MAL-NUL-IN-URL': '/docs/malformed-input/nul-in-url/',
    'MAL-WHITESPACE-ONLY-LINE': '/docs/malformed-input/whitespace-only-line/',
    'RFC9110-5.4-DUPLICATE-HOST': '/docs/host-header/duplicate-host/',
    'RFC9110-5.6.2-SP-BEFORE-COLON': '/docs/headers/sp-before-colon/',
    'SMUG-DUPLICATE-CL': '/docs/smuggling/duplicate-cl/',
    'RFC9112-2.2-BARE-LF-HEADER': '/docs/line-endings/bare-lf-header/',
    'RFC9112-2.2-BARE-LF-REQUEST-LINE': '/docs/line-endings/bare-lf-request-line/',
    'RFC9112-2.3-HTTP09-REQUEST': '/docs/request-line/http09-request/',
    'RFC9112-2.3-INVALID-VERSION': '/docs/request-line/invalid-version/',
    'RFC9112-3-CR-ONLY-LINE-ENDING': '/docs/line-endings/cr-only-line-ending/',
    'RFC9112-3-MISSING-TARGET': '/docs/request-line/missing-target/',
    'RFC9112-3-MULTI-SP-REQUEST-LINE': '/docs/request-line/multi-sp-request-line/',
    'RFC9112-3.2-FRAGMENT-IN-TARGET': '/docs/request-line/fragment-in-target/',
    'RFC9112-5-EMPTY-HEADER-NAME': '/docs/headers/empty-header-name/',
    'RFC9112-5-HEADER-NO-COLON': '/docs/headers/header-no-colon/',
    'RFC9112-5-INVALID-HEADER-NAME': '/docs/headers/invalid-header-name/',
    'RFC9112-5.1-OBS-FOLD': '/docs/headers/obs-fold/',
    'SMUG-CL-LEADING-ZEROS': '/docs/smuggling/cl-leading-zeros/',
    'SMUG-CL-NEGATIVE': '/docs/smuggling/cl-negative/',
    'RFC9112-6.1-CL-NON-NUMERIC': '/docs/content-length/cl-non-numeric/',
    'RFC9112-6.1-CL-PLUS-SIGN': '/docs/content-length/cl-plus-sign/',
    'SMUG-CL-TE-BOTH': '/docs/smuggling/cl-te-both/',
    'RFC9112-7.1-MISSING-HOST': '/docs/host-header/missing-host/',
    'SMUG-BARE-CR-HEADER-VALUE': '/docs/smuggling/bare-cr-header-value/',
    'SMUG-CHUNK-BARE-SEMICOLON': '/docs/smuggling/chunk-bare-semicolon/',
    'SMUG-CHUNK-EXT-CR': '/docs/smuggling/chunk-ext-cr/',
    'SMUG-CHUNK-EXT-CTRL': '/docs/smuggling/chunk-ext-ctrl/',
    'SMUG-CHUNK-EXT-LF': '/docs/smuggling/chunk-ext-lf/',
    'SMUG-CHUNK-HEX-PREFIX': '/docs/smuggling/chunk-hex-prefix/',
    'SMUG-CHUNK-LEADING-SP': '/docs/smuggling/chunk-leading-sp/',
    'SMUG-CHUNK-LF-TERM': '/docs/smuggling/chunk-lf-term/',
    'SMUG-CHUNK-LF-TRAILER': '/docs/smuggling/chunk-lf-trailer/',
    'SMUG-CHUNK-MISSING-TRAILING-CRLF': '/docs/smuggling/chunk-missing-trailing-crlf/',
    'SMUG-CHUNK-NEGATIVE': '/docs/smuggling/chunk-negative/',
    'SMUG-CHUNK-SPILL': '/docs/smuggling/chunk-spill/',
    'SMUG-CHUNK-UNDERSCORE': '/docs/smuggling/chunk-underscore/',
    'SMUG-CHUNKED-WITH-PARAMS': '/docs/smuggling/chunked-with-params/',
    'SMUG-CL-COMMA-DIFFERENT': '/docs/smuggling/cl-comma-different/',
    'SMUG-CL-COMMA-SAME': '/docs/smuggling/cl-comma-same/',
    'SMUG-CL-COMMA-TRIPLE': '/docs/smuggling/cl-comma-triple/',
    'SMUG-CL-EXTRA-LEADING-SP': '/docs/smuggling/cl-extra-leading-sp/',
    'SMUG-CL-HEX-PREFIX': '/docs/smuggling/cl-hex-prefix/',
    'SMUG-CL-INTERNAL-SPACE': '/docs/smuggling/cl-internal-space/',
    'SMUG-CL-OCTAL': '/docs/smuggling/cl-octal/',
    'SMUG-CL-TRAILING-SPACE': '/docs/smuggling/cl-trailing-space/',
	    'SMUG-CLTE-CONN-CLOSE': '/docs/smuggling/clte-conn-close/',
	    'SMUG-CLTE-DESYNC': '/docs/smuggling/clte-desync/',
	    'SMUG-CLTE-SMUGGLED-GET': '/docs/smuggling/clte-smuggled-get/',
	    'SMUG-CLTE-SMUGGLED-HEAD': '/docs/smuggling/clte-smuggled-head/',
	    'SMUG-TECL-SMUGGLED-GET': '/docs/smuggling/tecl-smuggled-get/',
	    'SMUG-TE-DUPLICATE-HEADERS-SMUGGLED-GET': '/docs/smuggling/te-duplicate-headers-smuggled-get/',
	    'SMUG-DUPLICATE-CL-SMUGGLED-GET': '/docs/smuggling/duplicate-cl-smuggled-get/',
	    'SMUG-CLTE-SMUGGLED-GET-CL-PLUS': '/docs/smuggling/clte-smuggled-get-cl-plus/',
	    'SMUG-CLTE-SMUGGLED-GET-CL-NON-NUMERIC': '/docs/smuggling/clte-smuggled-get-cl-non-numeric/',
	    'SMUG-CLTE-SMUGGLED-GET-TE-OBS-FOLD': '/docs/smuggling/clte-smuggled-get-te-obs-fold/',
		    'SMUG-CLTE-SMUGGLED-GET-TE-TRAILING-SPACE': '/docs/smuggling/clte-smuggled-get-te-trailing-space/',
		    'SMUG-CLTE-SMUGGLED-GET-TE-LEADING-COMMA': '/docs/smuggling/clte-smuggled-get-te-leading-comma/',
		    'SMUG-CLTE-SMUGGLED-GET-TE-CASE-MISMATCH': '/docs/smuggling/clte-smuggled-get-te-case-mismatch/',
		    'SMUG-CLTE-PIPELINE': '/docs/smuggling/clte-pipeline/',
		    'SMUG-CL0-BODY-POISON': '/docs/smuggling/cl0-body-poison/',
		    'SMUG-EXPECT-100-CL': '/docs/smuggling/expect-100-cl/',
		    'SMUG-EXPECT-100-CL-DESYNC': '/docs/smuggling/expect-100-cl-desync/',
		    'SMUG-GET-CL-BODY-DESYNC': '/docs/smuggling/get-cl-body-desync/',
		    'SMUG-GET-CL-PREFIX-DESYNC': '/docs/smuggling/get-cl-prefix-desync/',
		    'SMUG-HEAD-CL-BODY': '/docs/smuggling/head-cl-body/',
		    'SMUG-OPTIONS-CL-BODY': '/docs/smuggling/options-cl-body/',
		    'SMUG-OPTIONS-CL-BODY-DESYNC': '/docs/smuggling/options-cl-body-desync/',
		    'SMUG-OPTIONS-TE-OBS-FOLD': '/docs/smuggling/options-te-obs-fold/',
	    'SMUG-TE-CASE-MISMATCH': '/docs/smuggling/te-case-mismatch/',
    'SMUG-TE-DOUBLE-CHUNKED': '/docs/smuggling/te-double-chunked/',
    'SMUG-TE-DUPLICATE-HEADERS': '/docs/smuggling/te-duplicate-headers/',
    'SMUG-TE-EMPTY-VALUE': '/docs/smuggling/te-empty-value/',
    'SMUG-TE-FORMFEED': '/docs/smuggling/te-formfeed/',
    'SMUG-TE-HTTP10': '/docs/smuggling/te-http10/',
    'SMUG-TE-LEADING-COMMA': '/docs/smuggling/te-leading-comma/',
    'SMUG-TE-NOT-FINAL-CHUNKED': '/docs/smuggling/te-not-final-chunked/',
    'SMUG-TE-NULL': '/docs/smuggling/te-null/',
    'SMUG-TE-SP-BEFORE-COLON': '/docs/smuggling/te-sp-before-colon/',
    'SMUG-TE-TRAILING-SPACE': '/docs/smuggling/te-trailing-space/',
    'SMUG-TE-VTAB': '/docs/smuggling/te-vtab/',
    'SMUG-TE-IDENTITY': '/docs/smuggling/te-identity/',
    'SMUG-TE-XCHUNKED': '/docs/smuggling/te-xchunked/',
    'SMUG-PIPELINE-SAFE': '/docs/smuggling/pipeline-safe/',
    'SMUG-TECL-CONN-CLOSE': '/docs/smuggling/tecl-conn-close/',
    'SMUG-TECL-DESYNC': '/docs/smuggling/tecl-desync/',
    'SMUG-TECL-PIPELINE': '/docs/smuggling/tecl-pipeline/',
    'SMUG-TRAILER-AUTH': '/docs/smuggling/trailer-auth/',
    'SMUG-TRAILER-CL': '/docs/smuggling/trailer-cl/',
    'SMUG-TRAILER-HOST': '/docs/smuggling/trailer-host/',
    'SMUG-TRAILER-TE': '/docs/smuggling/trailer-te/',
    'SMUG-TRANSFER_ENCODING': '/docs/smuggling/transfer-encoding-underscore/',
    'COMP-CHUNKED-HEX-UPPERCASE': '/docs/body/chunked-hex-uppercase/',
    'COMP-CHUNKED-TRAILER-VALID': '/docs/body/chunked-trailer-valid/',
    'COMP-CONNECTION-CLOSE': '/docs/headers/connection-close/',
    'COMP-CONTENT-TYPE': '/docs/headers/content-type-presence/',
    'COMP-DATE-FORMAT': '/docs/headers/date-format/',
    'COMP-DATE-HEADER': '/docs/headers/date-header/',
    'COMP-HEAD-NO-BODY': '/docs/request-line/head-no-body/',
    'COMP-HOST-EMPTY-VALUE': '/docs/host-header/host-empty-value/',
    'COMP-HTTP10-DEFAULT-CLOSE': '/docs/headers/http10-default-close/',
    'COMP-HTTP10-NO-HOST': '/docs/host-header/http10-no-host/',
    'COMP-NO-1XX-HTTP10': '/docs/headers/no-1xx-http10/',
    'COMP-NO-CL-IN-204': '/docs/content-length/no-cl-in-204/',
    'COMP-HTTP12-VERSION': '/docs/request-line/http12-version/',
    'COMP-REQUEST-LINE-TAB': '/docs/request-line/request-line-tab/',
    'COMP-TRACE-WITH-BODY': '/docs/request-line/trace-with-body/',
    'COMP-VERSION-LEADING-ZEROS': '/docs/request-line/version-leading-zeros/',
    'COMP-VERSION-MISSING-MINOR': '/docs/request-line/version-missing-minor/',
    'COMP-VERSION-WHITESPACE': '/docs/request-line/version-whitespace/',
    'MAL-POST-CL-HUGE-NO-BODY': '/docs/malformed-input/post-cl-huge-no-body/',
    'MAL-RANGE-OVERLAPPING': '/docs/malformed-input/range-overlapping/',
    'MAL-URL-BACKSLASH': '/docs/malformed-input/url-backslash/',
    'MAL-URL-OVERLONG-UTF8': '/docs/malformed-input/url-overlong-utf8/',
    'MAL-URL-PERCENT-CRLF': '/docs/malformed-input/url-percent-crlf/',
    'MAL-URL-PERCENT-NULL': '/docs/malformed-input/url-percent-null/',
    'SMUG-ABSOLUTE-URI-HOST-MISMATCH': '/docs/smuggling/absolute-uri-host-mismatch/',
    'SMUG-CHUNK-BARE-CR-TERM': '/docs/smuggling/chunk-bare-cr-term/',
    'SMUG-CHUNK-INVALID-SIZE-DESYNC': '/docs/smuggling/chunk-invalid-size-desync/',
    'SMUG-CL-DOUBLE-ZERO': '/docs/smuggling/cl-double-zero/',
    'SMUG-CL-LEADING-ZEROS-OCTAL': '/docs/smuggling/cl-leading-zeros-octal/',
    'SMUG-CL-NEGATIVE-ZERO': '/docs/smuggling/cl-negative-zero/',
    'SMUG-CL-UNDERSCORE': '/docs/smuggling/cl-underscore/',
    'SMUG-MULTIPLE-HOST-COMMA': '/docs/smuggling/multiple-host-comma/',
    'SMUG-TE-OBS-FOLD': '/docs/smuggling/te-obs-fold/',
    'SMUG-TE-TAB-BEFORE-VALUE': '/docs/smuggling/te-tab-before-value/',
    'SMUG-TE-TRAILING-COMMA': '/docs/smuggling/te-trailing-comma/',
    'SMUG-TRAILER-CONTENT-TYPE': '/docs/smuggling/trailer-content-type/',
    'NORM-UNDERSCORE-CL': '/docs/normalization/underscore-cl/',
    'NORM-SP-BEFORE-COLON-CL': '/docs/normalization/sp-before-colon-cl/',
    'NORM-TAB-IN-NAME': '/docs/normalization/tab-in-name/',
    'NORM-CASE-TE': '/docs/normalization/case-te/',
    'NORM-UNDERSCORE-TE': '/docs/normalization/underscore-te/',
    'CAP-ETAG-304': '/docs/caching/etag-304/',
    'CAP-LAST-MODIFIED-304': '/docs/caching/last-modified-304/',
    'CAP-ETAG-IN-304': '/docs/caching/etag-in-304/',
    'CAP-INM-PRECEDENCE': '/docs/caching/inm-precedence/',
    'CAP-INM-WILDCARD': '/docs/caching/inm-wildcard/',
    'CAP-IMS-FUTURE': '/docs/caching/ims-future/',
    'CAP-IMS-INVALID': '/docs/caching/ims-invalid/',
    'CAP-INM-UNQUOTED': '/docs/caching/inm-unquoted/',
    'CAP-ETAG-WEAK': '/docs/caching/etag-weak/',
    ...
    'COOK-MULTI-HEADER': '/docs/cookies/multi-header/',
    'COOK-PARSED-BASIC': '/docs/cookies/parsed-basic/',
    'COOK-PARSED-MULTI': '/docs/cookies/parsed-multi/',
    'COOK-PARSED-EMPTY-VAL': '/docs/cookies/parsed-empty-val/',
    'COOK-PARSED-SPECIAL': '/docs/cookies/parsed-special/'
  };
  ...
  var SERVER_URLS = {
    ...
    'FastHTTP': '/servers/fasthttp/',
    'Flask': '/servers/flask/',
    'GenHTTP': '/servers/genhttp/',
    'Gin': '/servers/gin/',
    'Glyph11': '/servers/glyph/',
    'Gunicorn': '/servers/gunicorn/',
    'H2O': '/servers/h2o/',
    'HAProxy': '/servers/haproxy/',
    'Hyper': '/servers/hyper/',
    'Jetty': '/servers/jetty/',
    'Kestrel': '/servers/aspnet-minimal/',
    'Lighttpd': '/servers/lighttpd/',
    'NetCoreServer': '/servers/netcoreserver/',
    'Nginx': '/servers/nginx/',
    'Node': '/servers/node/',
    'Ntex': '/servers/ntex/',
    'PHP': '/servers/php/',
    ...
    'Sisk': '/servers/sisk/',
    'Spring Boot': '/servers/spring-boot/',
    'Tomcat': '/servers/tomcat/',
    'Traefik': '/servers/traefik/',
    'Uvicorn': '/servers/uvicorn/',
    'Workerman': '/servers/workerman/'
  };
